...
/// <remarks>
/// parallel code that does not take in account data dependencies among iterations, WRONG RESULTS! 
/// Used only as baseline for measuring impact of synchronization primitives
/// [Filter processing of full resolution image] in [634 ms]
/// </remarks>
int CParallelErrorAltaLuxFilter::Run()
{
	if (ClipLimit == 1.0)
